...
def admin_get_task_lists() -> Response:
...
def update_task_list(task_list_old_name: str, task_list_new_name: str, user_id: int) -> Response:
...
def create_task(task_list_name: str, task_name: str, description: str, user_id: int) -> Response:
...
def update_task(task_old_name: str, task_new_name: str, new_desc: str,
                task_list_name: str, user_id: int) -> Response:
    res, message = db.update_task(task_old_name, task_new_name, new_desc, task_list_name, user_id)
    status_code = 200 if res else 400
    return Response(status_code, message)
